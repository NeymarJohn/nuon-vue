...
import tokens from "~/constants/pancakeswap/tokens";
import { SerializedFarm } from "~/constants/pancakeswap/types";
import { BIG_ZERO, BIG_ONE } from "~/utils/pancakeswap/helpers";
...
const filterFarmsByQuoteToken = (
	...
	const preferredFarm = farms.find((farm) => {
		return preferredQuoteTokens.includes(farm.quoteToken.symbol!);
	});
