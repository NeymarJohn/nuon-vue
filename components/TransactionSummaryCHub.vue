		...
		<div class="l-flex l-flex--column u-full-width transaction-summary--chub">
			...
			<LayoutFlex direction="row-center-space-between">
				<LayoutFlex direction="row-center">
					<img :src="require(`~/assets/images/tokens/${fromToken}.png`)" alt="usdc image" height="50" width="50" class="u-mr-8">
					{{ fromToken }}
				</LayoutFlex>
			...
			<LayoutFlex direction="row-center-space-between u-pb-32 u-bb-medium-light-grey">
				<LayoutFlex direction="row-center">
					<img :src="require(`~/assets/images/tokens/${toToken}.png`)" alt="usdc image" height="50" width="50" class="u-mr-8">
					{{ toToken }}
				</LayoutFlex>
