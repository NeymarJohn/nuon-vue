...
export default {
	...
	data() {
		return {
			...
			tourCallbacks: {
				onSkip: () => this.setCookie("skip_ecosystem_overview_tour", "true"),
				onStop: () => this.setCookie("skip_ecosystem_overview_tour", "true"),
				onFinish: () => this.setCookie("skip_ecosystem_overview_tour", "true")
			},
		};
	},
	head () {
